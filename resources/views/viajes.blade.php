                ...
                <div class="col-md-8">
                    ...
                    <div class="card" style="background-color: rgb(163, 243, 236)">
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                <input id="numero_bus" type="number" class="form-control" name="numero_bus"
                                    value="{{ isset($viaje) ? $viaje->numero_bus : old('numero_bus') }}" required
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                <input id="fecha_viaje" type="date" class="form-control" name="fecha_viaje"
                                    value="{{ isset($viaje) ? $viaje->fecha_viaje : old('fecha_viaje') }}" required
                                    autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="hora_viaje" type="time" class="form-control" name="hora_viaje"
                                    value="{{ isset($viaje) ? $viaje->hora_viaje : old('hora_viaje') }}" required
                                    autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                <input id="hora_llegada" type="time" class="form-control" name="hora_llegada"
                                    value="{{ isset($viaje) ? $viaje->hora_llegada : old('hora_llegada') }}" required
                                    autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                <input id="origen" type="text" class="form-control" name="origen"
                                    value="{{ isset($viaje) ? $viaje->origen : old('origen') }}" required
                                    autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                <input id="num_asientos_dispo" type="number" class="form-control" name="num_asientos_dispo"
                                    value="{{ isset($viaje) ? $viaje->num_asientos : old('num_asientos_dispo') }}" required
                                    autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="precio" type="number" step="0.01" class="form-control" name="precio"
                                    value="{{ isset($viaje) ? $viaje->precio : old('precio') }}" required
                                    autocomplete="off">
                            </div>
                        </div>
